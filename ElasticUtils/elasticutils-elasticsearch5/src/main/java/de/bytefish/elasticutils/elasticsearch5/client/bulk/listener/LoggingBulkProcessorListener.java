...
package de.bytefish.elasticutils.elasticsearch5.client.bulk.listener;
...
public class LoggingBulkProcessorListener implements BulkProcessor.Listener {
    ...
    private static final Logger log = ESLoggerFactory.getLogger(LoggingBulkProcessorListener.class.getName());
