...
package de.bytefish.elastic.client;

import de.bytefish.elastic.client.bulk.configuration.BulkProcessorConfiguration;
import de.bytefish.elastic.client.bulk.options.BulkProcessingOptionsBuilder;
import de.bytefish.elastic.mapping.ElasticSearchMapping;
import de.bytefish.elastic.mapping.LocalWeatherDataMapper;
import de.bytefish.elastic.model.LocalWeatherData;
...
public class ElasticSearchClientTest {
    ...
    private List<LocalWeatherData> getData(int numberOfEntities) {
